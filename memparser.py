...
def get_signal_from_entry(raw_entry, line, signal_no, sig):
    ...
    sig.set_params(signal_name, signal_no, datatype, init_value, factor, offset, unit_name, minvalue, maxvalue,
...
def get_board_from_entry(board_entry, line, board):
    ...
    if entry[2] == "1":
        ...
        print("address_extend value is not a valid number at line : {}".format(line))
        print(entry[2])
        return -1
